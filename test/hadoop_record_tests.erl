...
%%%-------------------------------------------------------------------
%%% @doc
%%%   eunit unit tests for hadoop_record compiler.
%%% @end
%%%
%% @author Jan Henry Nystrom <JanHenryNystrom@gmail.com>
%% @copyright (C) 2013, Jan Henry Nystrom <JanHenryNystrom@gmail.com>
%%%-------------------------------------------------------------------
-module(hadoop_record_tests).
...
parse_distro_src_test_() ->
    [?_test(?assertMatch(_,
                         hadoop_record:compile(filename:basename(File),
                                               [{src_dir,
...
files(distro) ->
    Dir = filename:join([code:lib_dir(hadoop_record),
                         "test",
                         "hadoop_record",
                         "distro"]),
